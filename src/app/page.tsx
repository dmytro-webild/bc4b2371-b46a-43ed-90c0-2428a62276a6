...
export default function LandingPage() {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      useInvertedBackground={false}
      testimonials={[
        { id: "1", name: "Александр", role: "Вейпер", testimonial: "Доставка просто космос! Вкусы всегда свежие, оригинал 100%.", imageSrc: "http://img.b2bpic.net/free-photo/portrait-attractive-man-wearing-specs-looking-far-away-isolated-dark-neon-purple-color-background_231208-14359.jpg" },
        { id: "2", name: "Марина", role: "Клиент", testimonial: "Огромный выбор Elfliq. Теперь беру только тут, спасибо за баллы!", imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-woman-wearing-sunglasses_23-2149439866.jpg" },
        { id: "3", name: "Иван", role: "Вейпер", testimonial: "Цены отличные, ребята шарят в теме и всегда советуют топчики.", imageSrc: "http://img.b2bpic.net/free-photo/diverse-cultural-fashion-portrait_23-2151874300.jpg" },
        { id: "4", name: "Елена", role: "Постоянный покупатель", testimonial: "Liquid Spot — это любовь. Качественный сервис и отличные жидкости.", imageSrc: "http://img.b2bpic.net/free-photo/man-gray-dress-shirt-wearing-black-white-cap_410324-111.jpg" },
        { id: "5", name: "Дмитрий", role: "Вейпер", testimonial: "Заказываю Chaser постоянно. Всегда быстро и качественно упаковано.", imageSrc: "http://img.b2bpic.net/free-photo/stylish-woman-wearing-blue-wig-sitting-stairs-modern_158595-4333.jpg" },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={true}
      faqs={[
        { id: "f1", title: "Как работает система лояльности?", content: "За каждую покупку вы получаете Liquid Drops, которые можно списать в корзине при следующем заказе." },
        { id: "f2", title: "Как быстро вы доставляете?", content: "Мы отправляем заказы ежедневно, доставка занимает 1-2 дня по стране." },
        { id: "f3", title: "Продукция оригинальная?", content: "Да, мы работаем только с официальными дистрибьюторами Elfliq и Chaser." },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[{ text: "Перейти в Telegram", href: "https://t.me/LSpotManager" }]}
    />
  </div>
  ...
  <div id="footer" data-section="footer">
      <FooterBaseReveal
      columns={[
        { title: "Liquid Spot", items: [{ label: "О нас", href: "#hero" }, { label: "Магазин", href: "#products" }] },
        { title: "Поддержка", items: [{ label: "FAQ", href: "#faq" }, { label: "Telegram", href: "https://t.me/LSpotManager" }] },
        { title: "Правовая информация", items: [{ label: "Политика конфиденциальности", href: "#" }] },
      ]}
